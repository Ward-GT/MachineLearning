...
class Down(nn.Module):
    ...
    def forward(self, x, t):
        ...
        print(f"Down: x.shape: {x.shape}, emb.shape: {emb.shape}")
        return x + emb
...
class UNet(nn.Module):
    ...
    def forward(self, x, t):
        ...
        x1 = self.inc(x)
        #print(f"Input down1: t.shape: {t.shape}, x1.shape: {x1.shape}")
        x2 = self.down1(x1, t)
        #print(f"Input sa1: t.shape: {t.shape}, x2.shape: {x2.shape}")
        x2 = self.sa1(x2)
        #print(f"Input down2: t.shape: {t.shape}, x2.shape: {x2.shape}")
        x3 = self.down2(x2, t)
        #print(f"Input sa2: t.shape: {t.shape}, x3.shape: {x3.shape}")
        x3 = self.sa2(x3)
        x4 = self.down3(x3, t)
        x4 = self.sa3(x4)
